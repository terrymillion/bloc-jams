...
var myAlbum = {
    ...
    label: 'Zoo',
    year: '1993',
    albumArtUrl: 'assets/images/album_covers/undertow.png',
    songs: [
        { name: 'Intolerance', length: '4:54' },
        { name: 'Prison Sex', length: '4:56' },
        { name: 'Sober', length: '5:07' },
        { name: 'Bottom', length: '7:14' },
        { name: 'Crawl Away', length: '5:30' }
    ]
};